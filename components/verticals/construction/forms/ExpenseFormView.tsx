...
export function ExpenseFormView({ projectId }: { projectId: string }) {
    ...
    <div className="space-y-5">
      <header className="space-y-3">
        <nav aria-label="breadcrumb" className="flex items-center gap-1 text-xs font-medium text-slate-500">
          ...
          <ChevronRightIcon className="h-3.5 w-3.5" />
          <span className="text-slate-700">Añadir gasto</span>
        </nav>
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-obra-600">ObraRentable OS</p>
          <h1 className="mt-1 text-2xl font-bold text-slate-950 sm:text-3xl">Añadir gasto</h1>
